...
# Generate an image with FLUX 2 MAX
...
````yaml https://api.bfl.ai/openapi.json post /v1/flux-2-max
openapi: 3.1.0
info:
  title: BFL API
...
paths:
  /v1/flux-2-max:
    post:
      tags:
        - Models
      summary: Generate an image with FLUX 2 MAX
      description: Submits an image generation task with FLUX 2 MAX.
      operationId: generate_flux_2_max_v1_flux_2_max_post
      requestBody:
        required: true
        content:
          application/json:
          ...
          content:
            application/json:
              schema:
                ...
                title: Response Generate Flux 2 Max V1 Flux 2 Max Post
        '422':
