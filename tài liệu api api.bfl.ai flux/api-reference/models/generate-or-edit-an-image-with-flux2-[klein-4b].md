...
````yaml https://api.bfl.ai/openapi.json post /v1/flux-2-klein-4b
openapi: 3.1.0
info:
  title: BFL API
...
paths:
  /v1/flux-2-klein-4b:
    post:
      tags:
        - Models
      summary: Generate or edit an image with FLUX.2 [Klein 4B]
      description: Submits an image generation or editing task with FLUX.2 [Klein 4B].
      operationId: generate_flux_2_klein_4b_v1_flux_2_klein_4b_post
      requestBody:
        required: true
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/Flux2KleinInputs'
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                ...
                title: Response Generate Flux 2 Klein 4B V1 Flux 2 Klein 4B Post
        '422':
...
components:
  schemas:
    Flux2KleinInputs:
      ...
      required:
        - prompt
      title: Flux2KleinInputs
      description: Input model for FLUX.2 Klein (non-base) - like Pro but max 4 images.
    AsyncResponse:
      properties:
        id:
          type: string
